...
global $wpdb;
	...
	?>
	<style type="text/css">
	.aip_stt-templet-9 .plug_sttbtn{
		color: <?php echo $get_text_color; ?>;
	}
	.aip_stt-templet-9 .plug_sttbtn:hover{
		color: <?php echo $get_text_hvr_color; ?>;	
	}
	.aip_stt-templet-9 .plug_sttbtn:before{	
	    -webkit-box-shadow: inset 0 0 0 35px <?php echo $get_bg_color; ?>;
	    box-shadow: inset 0 0 0 35px <?php echo $get_bg_color; ?>;
	}
	.aip_stt-templet-9 .plug_sttbtn:hover:before{
		-webkit-box-shadow: inset 0 0 0 1px <?php echo $get_bg_hvr_color; ?>;
        box-shadow: inset 0 0 0 1px <?php echo $get_bg_hvr_color; ?>;
	}
	</style>
	<?php 