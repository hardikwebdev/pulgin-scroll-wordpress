...
global $wpdb;
	...
	?>
    <style type="text/css">
    .aip_stt-templet-19 .plug_sttbtn .plug_stttext_wrap,.aip_stt-templet-19 .plug_sttbtn .plug_stticon_inner .plug_stticon{
        color: <?php echo $get_text_color; ?>;
    }
    .aip_stt-templet-19 .plug_sttbtn:hover .plug_stttext_wrap,.aip_stt-templet-19 .plug_sttbtn:hover .plug_stticon_inner .plug_stticon{
        color: <?php echo $get_text_hvr_color; ?>;
    }
    .aip_stt-templet-19 .plug_sttbtn,.aip_stt-templet-19 .plug_sttbtn .plug_stticon_inner:after{
