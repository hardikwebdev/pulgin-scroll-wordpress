...
global $wpdb;
            ...
            $aip_front_end .= '<div class="aip_stt-hvr-effect">';
                $aip_front_end .= '<div class="plug_stticon_wrap">';
                    if( isset( $get_top_icon ) )  {
                        ...
                        $aip_front_end .= '<span class=""><span class="plug_stticon  '.$aip_icon_get.'"></span></span>';
                    }
	...
	?>
    <style type="text/css">
    .aip_stt-templet-18 .plug_sttbtn{
        color: <?php echo $get_text_color; ?>;
    }
    .aip_stt-templet-18 .plug_sttbtn:hover{
        color: <?php echo $get_text_hvr_color; ?>;
    }
    .aip_stt-templet-18 .plug_sttbtn:before,.aip_stt-templet-18 .plug_sttbtn:after{
